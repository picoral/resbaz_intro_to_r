...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{this_dogs_age <-}\StringTok{ }\NormalTok{my_pets}\OperatorTok{$}\NormalTok{age[}\DecValTok{1}\NormalTok{]}

\NormalTok{this_dogs_human_age <-}\StringTok{ }\DecValTok{15}

\ControlFlowTok{if}\NormalTok{ (this_dogs_age }\OperatorTok{>=}\StringTok{ }\DecValTok{2}\NormalTok{) \{}
\NormalTok{  this_dogs_human_age <-}\StringTok{ }\NormalTok{this_dogs_human_age }\OperatorTok{+}\StringTok{ }\DecValTok{9}
\NormalTok{\}}

\ControlFlowTok{if}\NormalTok{ (this_dogs_age }\OperatorTok{>=}\DecValTok{3}\NormalTok{) \{}
\NormalTok{  this_dogs_human_age <-}\StringTok{ }\NormalTok{this_dogs_human_age }\OperatorTok{+}\StringTok{ }\NormalTok{((this_dogs_age }\OperatorTok{-}\StringTok{ }\DecValTok{2}\NormalTok{) }\OperatorTok{*}\StringTok{ }\DecValTok{5}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{row_max_age <-}\StringTok{ }\KeywordTok{which}\NormalTok{(my_pets}\OperatorTok{$}\NormalTok{age }\OperatorTok{==}\StringTok{ }\NormalTok{max_age)}
\NormalTok{row_max_age}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{## print info for oldest pet}
\NormalTok{oldest_pet <-}\StringTok{ }\NormalTok{my_pets}\OperatorTok{$}\NormalTok{name[row_max_age]}
\NormalTok{oldest_pet}
\end{Highlighting}
\end{Shaded}
